					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Types of event</h3><br>
								<a id="new" href="eventType.php" class="btn btn-success">Add</a>
							...
							<div class="module-body table">
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										...
										<tr class="gradeA">
											<td><input type="checkbox" class="check" value="<?php echo $event['catId']; ?>"></td>
											<td><?php echo $event['name'] ?></td>
											<td><?php echo $event['desc'] ?></td>
											<td><img src="../images/event/<?php echo $event['img'] ?>" style="width: 200px;height: 90px;"></td>
										</tr>
									<?php }?>
									</tbody>
								</table>
	...
	$('input[type="checkbox"]').click(function(){
        ...
        if($(this).is(':checked')) { 
            if(len == 1){
                ...
                $('#edit').attr('href','eventType.php?id='+checkedId);
